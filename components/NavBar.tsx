...
import { Menu, X, Users, Linkedin } from 'lucide-react';
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="flex h-16 items-center justify-between">
          ...
          <a href="#hero" className="flex items-center gap-2.5 group">
            ...
            <span className="hidden sm:inline text-xs text-cyan-400/70 font-mono border border-cyan-400/20 rounded-full px-2 py-0.5">People Ops</span>
          </a>
